...
best5 = pd.read_csv("/data/ephemeral/level2-klue-nlp-10/code/prediction/output_66.csv")  # 66
best6 = pd.read_csv("/data/ephemeral/level2-klue-nlp-10/code/prediction/output_84.csv")  # 84
...
for idx in tqdm(range(len(best1))):
    ...
    # 31 34 36 47 66 84 -> 17 15 17 17 17 17  -> 개
    ensemble_probs = [(0.17)*x + (0.17)*y + (0.15)*z + (0.17)*a + (0.17)*b + (0.17)*c
                      for x, y, z, a, b, c in zip(best1_probs_list, 
                                                    best2_probs_list, 
                                                    best3_probs_list, 
                                                    best4_probs_list, 
                                                    best5_probs_list,
...
final.to_csv("/data/ephemeral/level2-klue-nlp-10/code/prediction/output_ensemble6_0116.csv", index = False)